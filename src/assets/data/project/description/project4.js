...
* 지도 교수님께서 학부연구생들에게 각자 주도하여 프로젝트를 진행할 수 있는 기회를 주셨는데, 저는 전기차 충전 관련한 사회적인 현상을 가까이서 지켜본 경험이 있어 이 주제로 선택하게 되었습니다.

* 한국환경공단으로부터 받은 전기차 충전소 및 충전기 데이터를 이용하여 충전 장소를 추천해주는 앱으로 기본적인 지도 기능, 충전소 검색 기능, 데이터 자동 수집 등 여러 기능이 구현되어있습니다.

* 한국기술학회의 2022 추계종합학술대회 및 대학생논문경진대회에 참가하여 은상을 수상하였습니다.

* 이 프로젝트를 통해 Node.js를 다루는 법에 대해서 심도있게 공부할 수 있었습니다. 특히, 데이터 수집기를 개발하면서 Node.js가 얼마나 안정적인 도구인지를 확인하는 계기가 됐습니다.

* 상태 관리의 어려움을 겪기 시작하여 Redux를 처음 사용해본 프로젝트 입니다.

* 현재 이 프로젝트는 개인 프로젝트로 전환한 상황이고, 실제로 문제를 겪고 있는 전기 자동차 운전자들에게 자료를 배포하고자 합니다.
