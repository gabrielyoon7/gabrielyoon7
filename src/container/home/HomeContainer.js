            ...
            <a className='text-decoration-none text-dark' href='https://github.com/gabrielyoon7' target='_blank'>
                <div className="p-5 mb-4 bg-light rounded-3">
                    <div className="container-fluid py-5">
                        ...
                        <button className="btn btn-sky btn-lg border rounded-3" type="button">Github에서 보기</button>
                    </div>
                </div>
            </a>
            ...
            <div className="row align-items-md-stretch">
                <div className="col-md-6">
                    <Link className='text-decoration-none ' to="/profile">
                        <div className="h-100 p-5 text-white bg-blue rounded-3">
                            <h2>About Me</h2>
                ...
                <div className="col-md-6">
                    <Link className='text-decoration-none ' to="/career">
                        <div className="h-100 p-5 text-light bg-sky border rounded-3">
                            <h2>Career History</h2>
                            <p>프론트엔드 개발자가 되기 위해 걸어온 길</p>
                            <button className="btn btn-outline-sky" type="button">고고씽 <i className="bi bi-arrow-right"></i></button>
                        </div>
                    </Link>
                </div>
            </div>
